...
func readEnvironment(cfg *Config) error {
	aliases := map[string]string{
		...
		"GOPHPROFILE_PYROSCOPE_ENABLED":               "PYROSCOPE_ENABLED",
		"GOPHPROFILE_PYROSCOPE_SERVER_ADDRESS":        "PYROSCOPE_SERVER_ADDRESS",
		"GOPHPROFILE_PYROSCOPE_AUTH_TOKEN":            "PYROSCOPE_AUTH_TOKEN",
	}
