...
func TestUpdateCropPersistsCropAndQueuesProcessing(t *testing.T) {
	...
	useCase := New(repo, nil, &storageStub{}, publisher, nil, nil)
...
func TestUpdateCropRejectsForeignAvatar(t *testing.T) {
	...
	useCase := New(repo, nil, &storageStub{}, &publisherStub{}, nil, nil)
...
func TestDeleteActivatesNewestRemainingAvatar(t *testing.T) {
	...
	useCase := New(repo, lifecycleThumbnailRepoStub{}, &storageStub{}, &publisherStub{}, nil, nil)
